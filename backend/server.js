...
var viewAppliedLeaves = require("./routes/viewAppliedLeaves");
...
router.all("/delete_user", deleteUser.delete);
...
router.all("/view_applied_leaves", viewAppliedLeaves.display);
