...
class assignTask extends Component {
  ...
  componentDidMount() {
    ...
    axios.post(apiBaseUrl + "assign_task", payload).then(function (response) {
      self.setState({
        ...
        <div className="ContainerPlacing">
          <Paper square>
            <Tabs indicatorColor="primary" textColor="primary" centered>
              <Tab
                label="Assign Task"
                onClick={this.onClickAssignTask.bind(this)}
              />
              <Tab
                label="View Assigned Task"
                onClick={this.onClickViewAssignTask.bind(this)}
              />
              <Tab
                label="To Do Task"
                onClick={this.onClickToDoTask.bind(this)}
              />
            </Tabs>
          </Paper>
          <Container fixed>
